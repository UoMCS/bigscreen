...
## @class
# Select the appropriate block to render a page based on an BigScreen URL.
# This allows a url of the form /block/item/path/?args to be parsed into
# something the BigScreen classes can use to render pages properly, and
...
# data, allowing BigScreen paths to be passed to the rest of the code without
